                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="1992-1996" @selected($skCouncil->term === '1992-1996')>1992-1996</option>
                                    <option value="1997-2002" @selected($skCouncil->term === '1997-2002')>1997-2002</option>
                                    <option value="2002-2007" @selected($skCouncil->term === '2002-2007')>2002-2007</option>
                                    <option value="2007-2010" @selected($skCouncil->term === '2007-2010')>2007-2010</option>
                                    <option value="2010-2013" @selected($skCouncil->term === '2010-2013')>2010-2013</option>
                                    <option value="2013-2018" @selected($skCouncil->term === '2013-2018')>2013-2018</option>
                                    <option value="2018-2023" @selected($skCouncil->term === '2018-2023')>2018-2023</option>
                                    <option value="2023-2027" @selected($skCouncil->term === '2023-2027')>2023-2027</option>
                                </select>
                                @error('term')
