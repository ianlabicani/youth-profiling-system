        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-lg border border-slate-200 overflow-hidden hover:shadow-xl transition group">
                ...
                <div class="p-8">
                    ...
                    <a href="{{ route('reports.demographics') }}" class="inline-block px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium transition group-hover:translate-x-1">
                        View Report →
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border border-slate-200 overflow-hidden hover:shadow-xl transition group">
                ...
                <div class="p-8">
                    ...
                    <a href="{{ route('reports.leadership') }}" class="inline-block px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-medium transition group-hover:translate-x-1">
                        View Report →
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border border-slate-200 overflow-hidden hover:shadow-xl transition group">
                ...
                <div class="p-8">
                    ...
                    <a href="{{ route('reports.engagement') }}" class="inline-block px-6 py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-700 font-medium transition group-hover:translate-x-1">
                        View Report →
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border border-slate-200 overflow-hidden hover:shadow-xl transition group">
                ...
                <div class="p-8">
                    ...
                    <a href="{{ route('reports.profiles') }}" class="inline-block px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 font-medium transition group-hover:translate-x-1">
                        View Report →
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border border-slate-200 overflow-hidden hover:shadow-xl transition group md:col-span-2">
                ...
                <div class="p-8">
                    ...
                    <a href="{{ route('reports.data-quality') }}" class="inline-block px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 font-medium transition group-hover:translate-x-1">
                        View Report →
                    </a>
                </div>
            </div>
