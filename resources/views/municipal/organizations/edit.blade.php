...
@section('municipal-content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 ml-10">Update organization details</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('municipal.organizations.update', $organization) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="border-b pb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="president_id" id="president_id" value="{{ $organization->president_id }}">
                            <div class="flex gap-2">
                                <div class="flex-1 px-4 py-2 border @error('president_id') border-red-500 @else border-gray-300 @enderror rounded-lg bg-gray-50" id="president_display">
                                    <span class="text-gray-800" id="president_text">
                                        @if($organization->president)
                                            {{ $organization->president->first_name }} {{ $organization->president->last_name }}
                                        @else
                        ...
                        <div>
                            ...
                            <input type="hidden" name="vice_president_id" id="vice_president_id" value="{{ $organization->vice_president_id }}">
                            <div class="flex gap-2">
                                <div class="flex-1 px-4 py-2 border border-gray-300 rounded-lg bg-gray-50" id="vice_president_display">
                                    <span class="text-gray-800" id="vice_president_text">
                                        @if($organization->vicePresident)
                                            {{ $organization->vicePresident->first_name }} {{ $organization->vicePresident->last_name }}
                                        @else
                        ...
                        <div>
                            ...
                            <input type="hidden" name="secretary_id" id="secretary_id" value="{{ $organization->secretary_id }}">
                            <div class="flex gap-2">
                                <div class="flex-1 px-4 py-2 border border-gray-300 rounded-lg bg-gray-50" id="secretary_display">
                                    <span class="text-gray-800" id="secretary_text">
                                        @if($organization->secretary)
                                            {{ $organization->secretary->first_name }} {{ $organization->secretary->last_name }}
                                        @else
                        ...
                        <div>
                            ...
                            <input type="hidden" name="treasurer_id" id="treasurer_id" value="{{ $organization->treasurer_id }}">
                            <div class="flex gap-2">
                                <div class="flex-1 px-4 py-2 border border-gray-300 rounded-lg bg-gray-50" id="treasurer_display">
                                    <span class="text-gray-800" id="treasurer_text">
                                        @if($organization->treasurer)
                                            {{ $organization->treasurer->first_name }} {{ $organization->treasurer->last_name }}
                                        @else
                ...
                <div class="border-b pb-6">
                    ...
                    <p class="text-sm text-gray-600 mb-3">Manage committee heads with their positions</p>
                ...
                <div class="border-b pb-6">
                    ...
                    <p class="text-sm text-gray-600 mb-3">Manage organization members</p>
                ...
                <div class="flex gap-4 pt-6">
                    ...
                    <a
                        href="{{ route('municipal.organizations.show', $organization) }}"
    ...
    <script>
        ...
        const existingMembers = {!! json_encode($organization->members ?? []) !!};
        const existingCommitteeHeads = {!! json_encode($organization->committee_heads ?? []) !!};
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (existingMembers && existingMembers.length > 0) {
                existingMembers.forEach(memberId => {
                    fetch(`{{ route('municipal.organizations.get-youth') }}?id=${memberId}`)
                        .then(r => r.json())
                        .then(youth => {
                            if (youth) {
                                selectedMembers.push({ id: youth.id, name: youth.name });
                                renderMembersList();
                            }
                        });
                });
            ...
            if (existingCommitteeHeads && existingCommitteeHeads.length > 0) {
                existingCommitteeHeads.forEach(committee => {
                    if (committee.head_id) {
                        fetch(`{{ route('municipal.organizations.get-youth') }}?id=${committee.head_id}`)
                            .then(r => r.json())
                            .then(youth => {
                                if (youth) {
                                    selectedCommitteeHeads.push({
