    ...
    <div class="h-screen flex flex-col">
        ...
        <div class="mb-4 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-2">Geographic visualization of registered youth across the municipality</p>
            </div>
            <a href="{{ route('municipal.dashboard') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition">
        ...
        <div class="mt-4 bg-white rounded-lg shadow-md p-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-sm text-gray-700">Intensity: Blue (low) → Red (high)</span>
                </div>
                ...
                <div class="text-sm text-gray-600">
                    <strong>Archived Records:</strong> {{ $youths->where('status', 'archived')->count() }}
                </div>
            </div>
        </div>
    </div>
